...
namespace Actividad18.Server.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        public ProductosController(CotextoTienda context)
        {
            _context = context;
        }
        ...
        {
            var producto = await _context.Productos.Include(p => p.Ventas).FirstOrDefaultAsync(p => p.Id == id);
        ...
        public async Task<ActionResult<Productos>> PostProductos(Productos productos)
        {
            ...
            {
                return Problem("Entity set 'CotextoTienda.Productos' is null.");
            }
